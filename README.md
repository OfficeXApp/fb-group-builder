# fb-group-builder — OfficeX Skill

## Quick Install

```bash
npx skills add OfficeXApp/fb-group-builder
```

> Or install on OfficeX: [officex.app/store/en/app/fb-group-builder](https://officex.app/store/en/app/fb-group-builder)

## About

This repository contains the skill documentation (SKILL.md) for the **fb-group-builder** app on OfficeX.
